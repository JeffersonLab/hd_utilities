// $Id$
//
//    File: DEventProcessor_photon_gun_hists.h
...
#ifndef _DEventProcessor_photon_gun_hists_
#define _DEventProcessor_photon_gun_hists_
...
class DEventProcessor_photon_gun_hists : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_photon_gun_hists";}
...
#endif // _DEventProcessor_photon_gun_hists_
