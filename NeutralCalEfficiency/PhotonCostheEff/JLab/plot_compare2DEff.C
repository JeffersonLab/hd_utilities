...
//
  ...
  gStyle->SetPadBottomMargin(0.15);
    ...
    // TString inMC_name ="DSelector_pi0pippim__B4_gen_amp_030600-030800_"+tag+".root";
    ...
    TH1D *dH1_E2_eff_BCAL_Ratio = new TH1D("dH1_E2_eff_BCAL_Ratio", "Ration of Data/MC", xbins, xlo, xhi);
    ...
    leg2->AddEntry(dP1_E2_eff_BCAL_Data,"Data","p");
    leg2->AddEntry(dP1_E2_eff_BCAL_MC,"MC","p");
    leg2->Draw();
    ...
    leg3->AddEntry(dP1_E2_eff_FCAL_Data,"Data","p");
    leg3->AddEntry(dP1_E2_eff_FCAL_MC,"MC","p");
    ...
    leg4->AddEntry(dP1_E2_eff_FCALBCAL_Data,"Data","p");
    leg4->AddEntry(dP1_E2_eff_FCALBCAL_MC,"MC","p");
    leg4->Draw();
    t1->DrawLatex(0.3,0.10,tag);
    ...
    hdata->GetYaxis()->SetTitle("Ratio Data/MC");
    ...
    hdata->SetTitle("Data/MC FCALBCAL");
    hdata->GetXaxis()->SetRangeUser(xmin,xmax);
    hdata->GetYaxis()->SetRangeUser(ymin,ymax);
    hdata->GetXaxis()->SetTitleSize(0.05);
    hdata->GetYaxis()->SetTitleSize(0.05);
    ...
    hdata->SetMarkerColor(2);
    hdata->SetMarkerStyle(20);
    hdata->SetMarkerSize(0.5);    hdata->Draw();
    ...
    c1->cd(1);
    dH2_E2_eff_FCAL_Data->SetTitle("DATA: Rel Eff FCAL");
    ...
    c1->cd(2);
    dH2_E2_eff_FCAL_MC->SetTitle("MC: Rel Eff FCAL");
    ...
    c1->cd(3);
    dH2_E2_eff_BCAL_Data->SetTitle("DATA: Rel Eff BCAL");
    ...
    c1->cd(4);
    dH2_E2_eff_BCAL_MC->SetTitle("MC: Rel Eff BCAL");
    ...
    c1->cd(5);
    dH2_E2_eff_FCALBCAL_Data->SetTitle("DATA: Rel Eff FCALBCAL");
    ...
    c1->cd(6);
    dH2_E2_eff_FCALBCAL_MC->SetTitle("MC: Rel Eff FCALBCAL");
    ...
    c0->SaveAs("plot_compare2DEff_"+tag+".pdf(");
    c1->SaveAs("plot_compare2DEff_"+tag+".pdf");
    c2->SaveAs("plot_compare2DEff_"+tag+".pdf");
    // c3->SaveAs("plot_compare2DEff_"+tag+".pdf");
    c4->SaveAs("plot_compare2DEff_"+tag+".pdf");
    // c5->SaveAs("plot_compare2DEff_"+tag+".pdf");
    c6->SaveAs("plot_compare2DEff_"+tag+".pdf)");
    // c7->SaveAs("plot_compare2DEff_"+tag+".pdf)");
