...
void DSelector_selector::Init(TTree *locTree)
{
	...
	dOutputFileName = "histogram_da.root"; //"" for none
	dOutputTreeFileName = "entries_da.root"; //"" for none
    ...
    h_m_pi0_M = new TH1F("h_m_pi0_M","",70,0.1,0.17);
    h_m_omega_M = new TH1F("h_m_omega_M","",180,0.7,0.88);
	...
	dTreeInterface->Create_Branch_FundamentalArray<Double_t>("Pgamma1_raw", "my_int");
	dTreeInterface->Create_Branch_FundamentalArray<Double_t>("Pgamma2_raw", "my_int");
...
//		dTreeInterface->Fill_Fundamental<Int_t>("my_int_array", locRunNumber, loc_i); //2nd argument = value, 3rd = array index
	/*
	...
	*/
	...
	for(UInt_t loc_i = 0; loc_i < Get_NumCombos(); ++loc_i)
	{
		...
		TLorentzVector locPhoton2P4_Measured = dPhoton2Wrapper->Get_P4_Measured();
                ...
                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma1_raw", locPhoton1P4_Measured.Px(), 0); 
                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma1_raw", locPhoton1P4_Measured.Py(), 1); 
                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma1_raw", locPhoton1P4_Measured.Pz(), 2); 
                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma1_raw", locPhoton1P4_Measured.E(), 3);

                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma2_raw", locPhoton2P4_Measured.Px(), 0); 
                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma2_raw", locPhoton2P4_Measured.Py(), 1); 
                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma2_raw", locPhoton2P4_Measured.Pz(), 2); 
                dTreeInterface->Fill_Fundamental<Double_t>("Pgamma2_raw", locPhoton2P4_Measured.E(), 3); 
...
//        // theta of proton
        ...
        if( same_event && cutPBE && cutmisE && cutmisTM &&  cutmmsq && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega) {h_KinFitChiSq->Fill(chisq);h_KinFitCL->Fill(kinfitCL);h_KinFitChiSq_best->Fill(chisq_0);}
        if( same_event && cutPBE && cutkinfitCL && cutmmsq && cutmisTM && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega) h_MissingE->Fill(misE); 
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega) h_MissingMassSquared->Fill(mmsq); 
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmmsq && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega) h_MissingTM->Fill(misTM); 
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vr && cutmpi0 && cutmomega) h_KinVertex_z_pre->Fill(kin_vz);
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutmpi0 && cutmomega) h_KinVertex_r_pre->Fill(kin_vx, kin_vy);
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmomega){ h_m_pi0->Fill(m_pi0);}
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmpi0) h_m_omega->Fill(m_omega);
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega) {h_the_proton->Fill(theta_proton); h_the_pip->Fill(theta_pip); h_the_pim->Fill(theta_pim);}
        if( same_event && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega) h_PBE->Fill(be); 
      
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega) {
           h_costhe_gam->Fill(costhe);
           h_Egam->Fill(Egam_min);
           h_beamdeltaT->Fill(beamdeltaT);
        }
//        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr) {
        if( same_event && cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmpi0 && cutmomega)       
            Ncombo_aft++;
        }
        else {
        ...
        if( cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmomega){
            h_m_pi0_M->Fill(m_pi0);}
        if( cutPBE && cutkinfitCL && cutmisE && cutmisTM && cutmmsq && cutkin_vz && cutkin_vr && cutmpi0) h_m_omega_M->Fill(m_omega);
