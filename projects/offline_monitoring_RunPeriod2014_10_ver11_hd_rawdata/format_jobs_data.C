...
int format_jobs_data(Bool_t debug = false){
  ...
  while(IN >> id >> run >> file >> jobId
    ...
    if(timeSubmittedDay != "NULL" && timeSubmittedTime != "NULL"){
      ...
      if(debug) cout << "timeSubmitted is NULL for run " << run << " file " << file << endl;
    ...
    if(timeDependencyDay != "NULL" && timeDependencyTime != "NULL"){
      ...
      if(debug) cout << "timeDependency is NULL for run " << run << " file " << file << endl;
    ...
    if(timePendingDay != "NULL" && timePendingTime != "NULL"){
      ...
      if(debug) cout << "timePending is NULL for run " << run << " file " << file << endl;
      utimePending = -40000;
    }
    ...
    if(timeStagingInDay != "NULL" && timeStagingInTime != "NULL"){
      ...
      if(debug) cout << "timeStagingIn is NULL for run " << run << " file " << file << endl;
    ...
    if(timeActiveDay != "NULL" && timeActiveTime != "NULL"){
      ...
      if(debug) cout << "timeActive is NULL for run " << run << " file " << file << endl;
      utimeActive = -160000;
    }
    ...
    if(timeStagingOutDay != "NULL" && timeStagingOutTime != "NULL"){
      ...
      if(debug) cout << "timeStagingOut is NULL for run " << run << " file " << file << endl;
    ...
    system("rm -f ___tmp1.txt");
      ...
      if(debug) cout << "timeComplete is NULL for run " << run << " file " << file << endl;
