...
int analyze(Int_t TOTALTIME = 60, Bool_t debug = false){
  ...
  // 7. - 1. (total)
  TH1F *hcomplete_submitted = new TH1F("hcomplete_submitted",";completed time - submitted time (hours);",TOTALTIME,0,TOTALTIME*10);
  
  // 2. - 1.
  TH1F *hdependency_submitted = new TH1F("hdependency_submitted",";dependency time - submitted time (hours);",TOTALTIME,0,TOTALTIME*10);

  // 3. - 2.
  TH1F *hpending_dependency = new TH1F("hpending_dependency",";pending time - dependency time (hours);",TOTALTIME,0,TOTALTIME*10);

  // 4. - 3.
  TH1F *hstagingIn_pending = new TH1F("hstagingIn_pending",";stagingIn time - pending time (hours);",TOTALTIME,0,TOTALTIME*10);

  // 5. - 4.
  TH1F *hactive_stagingIn = new TH1F("hactive_stagingIn",";active time - stagingIn time (hours);",TOTALTIME,0,TOTALTIME*10);

  // 6. - 5.
  TH1F *hstagingOut_active = new TH1F("hstagingOut_active",";stagingOut time - active time (hours);",TOTALTIME,0,TOTALTIME*10);

  // 7. - 6.
  TH1F *hcomplete_stagingOut = new TH1F("hcomplete_stagingOut",";complete time - stagingOut time (hours);",TOTALTIME,0,TOTALTIME*10);
  ...
  TH1F *hsubmitTimeSinceInit     = new TH1F("hsubmitTimeSinceInit",";submit time since t_{0};",TOTALTIME * 10,0,TOTALTIME);
  TH1F *hdependencyTimeSinceInit = new TH1F("hdependencyTimeSinceInit",";dependency time since t_{0};",TOTALTIME * 10,0,TOTALTIME);
  TH1F *hpendingTimeSinceInit    = new TH1F("hpendingTimeSinceInit",";pending time since t_{0};",TOTALTIME * 10,0,TOTALTIME);
  TH1F *hstagingInTimeSinceInit  = new TH1F("hstagingInTimeSinceInit",";staging in time since t_{0};",TOTALTIME * 10,0,TOTALTIME);
  TH1F *hactiveTimeSinceInit     = new TH1F("hactiveTimeSinceInit",";active time since t_{0};",TOTALTIME * 10,0,TOTALTIME);
  TH1F *hstagingOutTimeSinceInit = new TH1F("hstagingOutTimeSinceInit",";staging out time since t_{0};",TOTALTIME * 10,0,TOTALTIME);
  TH1F *hcompleteTimeSinceInit   = new TH1F("hcompleteTimeSinceInit",";complete time since t_{0};",TOTALTIME * 10,0,TOTALTIME);
