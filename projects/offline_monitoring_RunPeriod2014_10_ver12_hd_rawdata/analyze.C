...
Int_t convert_to_sec(std::string input);
...
int analyze(){
  ...
  TH1F *hsubmitTimeSinceInit = new TH1F("hsubmitTimeSinceInit",";submit time since t_{0};",400,0,40);
  TH1F *hcompleteTimeSinceInit = new TH1F("hcompleteTimeSinceInit",";complete time since t_{0};",400,0,40);
  ...
  TH1F *haccumulate_submitTimeSinceInit = new TH1F("haccumulate_submitTimeSinceInit",";submit time since t_{0}",400,0,40);
  ...
  TH1F *haccumulate_completeTimeSinceInit = new TH1F("haccumulate_completeTimeSinceInit",";complete time since t_{0}",400,0,40);
