...
//
  ...
  gStyle->SetPadBottomMargin(0.15);
   ...
   c0->Divide(3,2);
    ...
    Double_t max_contentA_BCAL = CostheStarA_BCAL->GetBinContent(max_bin);     // use as normalization for efficiency
    max_bin = CostheStarA_FCAL->GetMaximumBin();
    Double_t max_contentA_FCAL = CostheStarA_FCAL->GetBinContent(max_bin);     // use as normalization for efficiency
    max_bin = CostheStarA_FCALBCAL->GetMaximumBin();
    Double_t max_contentA_FCALBCAL = CostheStarA_FCALBCAL->GetBinContent(max_bin);     // use as normalization for efficiency
