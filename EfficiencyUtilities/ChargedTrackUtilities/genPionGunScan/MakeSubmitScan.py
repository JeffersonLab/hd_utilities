...
# BASE_DIR = "/home/fs7/jzarling/MCPhotonEffOut/PiPlus_ScanP_4Theta_G4"
BASE_DIR = "/home/fs7/jzarling/MCPhotonEffOut/PiMinus_ScanThetaMore_2GeV_G4"
...
THETA   = "5." #Used if scanning over E
PION_P = "2." #Used if scanning over theta
# THETA = "25."
...
def main(argv):
	...
	parser_usage = "this_program.py run min_scan_val max_scan_val events_per_val(default=10,000) step(default=0.05GeV/degrees) run_interactive(default=0, 1 to run in terminal)"
	...
	PION_PID_STR="-1000"
	if(PION_CHARGE==1): PION_PID_STR="108"
	if(PION_CHARGE==-1): PION_PID_STR="109"
	if(not (PION_CHARGE==1 or PION_CHARGE==-1)):
		print "ERROR: INVALID PION_CHARGE SUPPLIED! (please enter either 1 or -1)"
		return 0
	...
	while current_val < MAX_VAL:
		...
		if(SCAN_OVER_ENERGY): replace_particlegun_dict = {"KINE_TOREPLACE":"KINE   "+PION_PID_STR+"      "+str(current_val)+"       "+THETA+"   0.      0.            0.        1000."}
		if(SCAN_OVER_THETA): replace_particlegun_dict = {"KINE_TOREPLACE":"KINE   "+PION_PID_STR+"      "+PION_P+"       "+str(current_val)+"   0.      0.            0.        1000."}
