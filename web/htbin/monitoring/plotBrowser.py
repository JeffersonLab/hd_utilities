...
def print_option_selector(options):
    ...
    plotNames.append(["__CDC_cdc_raw_intpp","CDC Raw Integral (ver > 3)"])
    plotNames.append(["__CDC_cdc_raw_t","CDC Raw Time (ver > 3)"])
    plotNames.append(["__CDC_cdc_ped","CDC Ped (ver > 3)"])
    plotNames.append(["__CDC_cdc_raw_intpp_vs_n","CDC Raw Integral vs straw (ver > 3)"])
    plotNames.append(["__CDC_cdc_raw_t_vs_n","CDC Raw Time vs straw (ver > 3)"])
    plotNames.append(["__CDC_cdc_ped_vs_n","CDC Ped vs straw (ver > 3)"])
    plotNames.append(["__CDC_cdc_windata_ped_vs_n","CDC WinData Ped vs straw (ver > 10)"])
    plotNames.append(["bcal_summary","BCAL Summary"])
    plotNames.append(["bcal_times","BCAL Timing (ver > 5)"])
    plotNames.append(["bcal_occupancy","BCAL Occupancy"])
    plotNames.append(["bcal_cluster","BCAL Cluster"])
    plotNames.append(["__bcal_bcal_shower_plane","BCAL Shower Position (ver < 6)"])
    plotNames.append(["bcal_shower","BCAL Shower (ver > 5)"])
    plotNames.append(["bcal_hist_eff","BCAL Efficiency (ver > 11)"])
    ...
    plotNames.append(["HistMacro_Tracking","Track Summary (ver <= 3)"])
    plotNames.append(["HistMacro_Tracking_p1","Track Summary 1 (ver > 3)"])
    plotNames.append(["HistMacro_Tracking_p2","Track Summary 2 (ver > 3)"])
    plotNames.append(["HistMacro_Tracking_p3","Track Summary 3 (ver > 4)"])	
