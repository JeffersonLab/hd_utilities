...
// Wed Aug 31 10:31:43 2011 by ROOT version 5.28/00
// from TTree thrown/Thrown Event parameters
...
#include <TFile.h>
#include <TSelector.h>
   const Int_t kMaxpip = 2;
   const Int_t kMaxpim = 2;
   const Int_t kMaxKp = 1;
   const Int_t kMaxKm = 1;
   const Int_t kMaxproton = 1;
   const Int_t kMaxphoton = 2;
   const Int_t kMaxneutron = 1;
   const Int_t kMaxpip_match = 2;
   const Int_t kMaxpim_match = 2;
   const Int_t kMaxKp_match = 1;
   const Int_t kMaxKm_match = 1;
   const Int_t kMaxproton_match = 1;
   const Int_t kMaxphoton_match = 2;
   const Int_t kMaxneutron_match = 1;

class b1pi_gen : public TSelector {
public :
 ...
 //Event           *T;
   ...
   TBranch        *b_T_target_fUniqueID;   //!
   TBranch        *b_T_target_fBits;   //!
   TBranch        *b_T_target_fP_fUniqueID;   //!
   TBranch        *b_T_target_fP_fBits;   //!
   TBranch        *b_T_target_fP_fX;   //!
   TBranch        *b_T_target_fP_fY;   //!
   TBranch        *b_T_target_fP_fZ;   //!
   TBranch        *b_T_target_fE;   //!
   TBranch        *b_T_beam_fUniqueID;   //!
   TBranch        *b_T_beam_fBits;   //!
   TBranch        *b_T_beam_fP_fUniqueID;   //!
   TBranch        *b_T_beam_fP_fBits;   //!
   TBranch        *b_T_beam_fP_fX;   //!
   TBranch        *b_T_beam_fP_fY;   //!
   TBranch        *b_T_beam_fP_fZ;   //!
   TBranch        *b_T_beam_fE;   //!
   TBranch        *b_T_vertex_fUniqueID;   //!
   TBranch        *b_T_vertex_fBits;   //!
   TBranch        *b_T_vertex_fX;   //!
   TBranch        *b_T_vertex_fY;   //!
   TBranch        *b_T_vertex_fZ;   //!
   TBranch        *b_T_W_fUniqueID;   //!
   TBranch        *b_T_W_fBits;   //!
   TBranch        *b_T_W_fP_fUniqueID;   //!
   TBranch        *b_T_W_fP_fBits;   //!
   TBranch        *b_T_W_fP_fX;   //!
   TBranch        *b_T_W_fP_fY;   //!
   TBranch        *b_T_W_fP_fZ;   //!
   TBranch        *b_T_W_fE;   //!
   TBranch        *b_T_all_fiducial;   //!
   TBranch        *b_T_all_mesons_fiducial;   //!
   TBranch        *b_T_all_photons_fiducial;   //!
   TBranch        *b_T_all_neutrons_fiducial;   //!
   TBranch        *b_T_all_protons_fiducial;   //!

   b1pi_gen(TTree * /*tree*/ =0) { }
   virtual ~b1pi_gen() { }
...
void b1pi_gen::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("fUniqueID", &fUniqueID, &b_T_fUniqueID);
   fChain->SetBranchAddress("fBits", &fBits, &b_T_fBits);
   fChain->SetBranchAddress("event", &event, &b_T_event);
   fChain->SetBranchAddress("Npip", &Npip, &b_T_Npip);
   fChain->SetBranchAddress("Npim", &Npim, &b_T_Npim);
   fChain->SetBranchAddress("NKp", &NKp, &b_T_NKp);
   fChain->SetBranchAddress("NKm", &NKm, &b_T_NKm);
   fChain->SetBranchAddress("Nproton", &Nproton, &b_T_Nproton);
   fChain->SetBranchAddress("Nphoton", &Nphoton, &b_T_Nphoton);
   fChain->SetBranchAddress("Nneutron", &Nneutron, &b_T_Nneutron);
   fChain->SetBranchAddress("pip", &pip_, &b_T_pip_);
   ...
   fChain->SetBranchAddress("pim", &pim_, &b_T_pim_);
   ...
   fChain->SetBranchAddress("Kp", &Kp_, &b_T_Kp_);
   ...
   fChain->SetBranchAddress("Km", &Km_, &b_T_Km_);
   ...
   fChain->SetBranchAddress("proton", &proton_, &b_T_proton_);
   ...
   fChain->SetBranchAddress("photon", &photon_, &b_T_photon_);
   ...
   fChain->SetBranchAddress("neutron", &neutron_, &b_T_neutron_);
   ...
   fChain->SetBranchAddress("pip_match", &pip_match_, &b_T_pip_match_);
   ...
   fChain->SetBranchAddress("pim_match", &pim_match_, &b_T_pim_match_);
   ...
   fChain->SetBranchAddress("Kp_match", &Kp_match_, &b_T_Kp_match_);
   ...
   fChain->SetBranchAddress("Km_match", &Km_match_, &b_T_Km_match_);
   ...
   fChain->SetBranchAddress("proton_match", &proton_match_, &b_T_proton_match_);
   ...
   fChain->SetBranchAddress("photon_match", &photon_match_, &b_T_photon_match_);
   ...
   fChain->SetBranchAddress("neutron_match", &neutron_match_, &b_T_neutron_match_);
   ...
   fChain->SetBranchAddress("target.fUniqueID", &target_fUniqueID, &b_T_target_fUniqueID);
   fChain->SetBranchAddress("target.fBits", &target_fBits, &b_T_target_fBits);
   fChain->SetBranchAddress("target.fP.fUniqueID", &target_fP_fUniqueID, &b_T_target_fP_fUniqueID);
   fChain->SetBranchAddress("target.fP.fBits", &target_fP_fBits, &b_T_target_fP_fBits);
   fChain->SetBranchAddress("target.fP.fX", &target_fP_fX, &b_T_target_fP_fX);
   fChain->SetBranchAddress("target.fP.fY", &target_fP_fY, &b_T_target_fP_fY);
   fChain->SetBranchAddress("target.fP.fZ", &target_fP_fZ, &b_T_target_fP_fZ);
   fChain->SetBranchAddress("target.fE", &target_fE, &b_T_target_fE);
   fChain->SetBranchAddress("beam.fUniqueID", &beam_fUniqueID, &b_T_beam_fUniqueID);
   fChain->SetBranchAddress("beam.fBits", &beam_fBits, &b_T_beam_fBits);
   fChain->SetBranchAddress("beam.fP.fUniqueID", &beam_fP_fUniqueID, &b_T_beam_fP_fUniqueID);
   fChain->SetBranchAddress("beam.fP.fBits", &beam_fP_fBits, &b_T_beam_fP_fBits);
   fChain->SetBranchAddress("beam.fP.fX", &beam_fP_fX, &b_T_beam_fP_fX);
   fChain->SetBranchAddress("beam.fP.fY", &beam_fP_fY, &b_T_beam_fP_fY);
   fChain->SetBranchAddress("beam.fP.fZ", &beam_fP_fZ, &b_T_beam_fP_fZ);
   fChain->SetBranchAddress("beam.fE", &beam_fE, &b_T_beam_fE);
   fChain->SetBranchAddress("vertex.fUniqueID", &vertex_fUniqueID, &b_T_vertex_fUniqueID);
   fChain->SetBranchAddress("vertex.fBits", &vertex_fBits, &b_T_vertex_fBits);
   fChain->SetBranchAddress("vertex.fX", &vertex_fX, &b_T_vertex_fX);
   fChain->SetBranchAddress("vertex.fY", &vertex_fY, &b_T_vertex_fY);
   fChain->SetBranchAddress("vertex.fZ", &vertex_fZ, &b_T_vertex_fZ);
   fChain->SetBranchAddress("W.fUniqueID", &W_fUniqueID, &b_T_W_fUniqueID);
   fChain->SetBranchAddress("W.fBits", &W_fBits, &b_T_W_fBits);
   fChain->SetBranchAddress("W.fP.fUniqueID", &W_fP_fUniqueID, &b_T_W_fP_fUniqueID);
   fChain->SetBranchAddress("W.fP.fBits", &W_fP_fBits, &b_T_W_fP_fBits);
   fChain->SetBranchAddress("W.fP.fX", &W_fP_fX, &b_T_W_fP_fX);
   fChain->SetBranchAddress("W.fP.fY", &W_fP_fY, &b_T_W_fP_fY);
   fChain->SetBranchAddress("W.fP.fZ", &W_fP_fZ, &b_T_W_fP_fZ);
   fChain->SetBranchAddress("W.fE", &W_fE, &b_T_W_fE);
   fChain->SetBranchAddress("all_fiducial", &all_fiducial, &b_T_all_fiducial);
   fChain->SetBranchAddress("all_mesons_fiducial", &all_mesons_fiducial, &b_T_all_mesons_fiducial);
   fChain->SetBranchAddress("all_photons_fiducial", &all_photons_fiducial, &b_T_all_photons_fiducial);
   fChain->SetBranchAddress("all_neutrons_fiducial", &all_neutrons_fiducial, &b_T_all_neutrons_fiducial);
   fChain->SetBranchAddress("all_protons_fiducial", &all_protons_fiducial, &b_T_all_protons_fiducial);
}

Bool_t b1pi_gen::Notify()
{
