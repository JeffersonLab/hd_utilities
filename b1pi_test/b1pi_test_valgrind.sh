...
command="hd_root -PJANA:BATCH_MODE=1 --nthreads=$NTHREADS -PPLUGINS=danarest hdgeant_smeared.hddm"
echo command = $command
valgrind --tool=callgrind --demangle=yes --callgrind-out-file=profile.callgrind $command
