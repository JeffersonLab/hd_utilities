// $Id$
//
//    File: DEventProcessor_FCAL_diphoton_gun_hists.h
...
#ifndef _DEventProcessor_FCAL_diphoton_gun_hists_
#define _DEventProcessor_FCAL_diphoton_gun_hists_
...
class DEventProcessor_FCAL_diphoton_gun_hists : public jana::JEventProcessor
{
	public:
		const char* className(void){return "DEventProcessor_FCAL_diphoton_gun_hists";}
...
#endif // _DEventProcessor_FCAL_diphoton_gun_hists_
