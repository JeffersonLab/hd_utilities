...
if __name__ == "__main__":
  ...
  parser.add_argument("--swif-hd-root-output-dest-dir",        required = True,  help = "JLab directory, where output files of successful hd_root processes will be copied to")
  parser.add_argument("--swif-log-files-output-dest-dir",      required = True,  help = "JLab directory, where log files of successful hd_root processes will be copied to")
  parser.add_argument("--swif-failed-hd-root-output-dest-dir", required = True,  help = "JLab directory, where all files of failed hd_root processes will be copied to")
