...
def get_evio_file_paths_for_run(
  ...
  if evio_files_count is None:
    ...
    for evio_file_index in range(evio_files_count):
      ...
      if ignore_evio_file:
        print(f"Excluding EVIO file '{evio_file_path}' according to RCDB setting 'evio_last_files_excluded'")
...
def get_evio_file_paths(
  ...
  missing_evio_files = sorted(tuple(err.detail or "" for err in rcdb_errors if err.errorType == EvioFileErrorType.MISSING_EVIO_FILE))
