...
def get_evio_files(
  ...
  for run_number in run_list:
    ...
    evio_files:  list[str]
    rcdb_errors: list[EvioFilesError]
    evio_files, rcdb_errors = get_evio_files_for_run(run_info, raw_data_root)
...
def main(args: argparse.Namespace) -> None:
  ...
  evio_files_per_run: dict[int, list[str]] = get_evio_files(db, run_period, run_list, raw_data_root)
