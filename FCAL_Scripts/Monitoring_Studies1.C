...
vector<TString> Monitoring_Studies_basesToMonitor(int skipNum){
  ...
  // bases pulled out in Jan 2016
    basesToReplace.push_back( prefix+formatTreeName(-25,-1) );
    basesToReplace.push_back( prefix+formatTreeName(-24,-15) );
    basesToReplace.push_back( prefix+formatTreeName(-24,6) );
    basesToReplace.push_back( prefix+formatTreeName(-22,-5) );
    basesToReplace.push_back( prefix+formatTreeName(-20,-12) );
    basesToReplace.push_back( prefix+formatTreeName(-18,15) );
    basesToReplace.push_back( prefix+formatTreeName(-17,-11) );
    basesToReplace.push_back( prefix+formatTreeName(-17,9) );
    basesToReplace.push_back( prefix+formatTreeName(-12,-25) );
    basesToReplace.push_back( prefix+formatTreeName(-10,5) );
    basesToReplace.push_back( prefix+formatTreeName(-7,-15) );
    basesToReplace.push_back( prefix+formatTreeName(-5,-24) );
    basesToReplace.push_back( prefix+formatTreeName(-2,13) );
    basesToReplace.push_back( prefix+formatTreeName(-2,16) );
    basesToReplace.push_back( prefix+formatTreeName(0,-21) );  
    basesToReplace.push_back( prefix+formatTreeName(0,26) );  
    basesToReplace.push_back( prefix+formatTreeName(4,-11) );
    basesToReplace.push_back( prefix+formatTreeName(5,-24) );
    basesToReplace.push_back( prefix+formatTreeName(5,24) );
    basesToReplace.push_back( prefix+formatTreeName(10,6) );
    basesToReplace.push_back( prefix+formatTreeName(12,-14) );
    basesToReplace.push_back( prefix+formatTreeName(13,-23) );
    basesToReplace.push_back( prefix+formatTreeName(13,15) );
    basesToReplace.push_back( prefix+formatTreeName(14,-24) );
    basesToReplace.push_back( prefix+formatTreeName(14,-20) );
    basesToReplace.push_back( prefix+formatTreeName(17,-15) );
    basesToReplace.push_back( prefix+formatTreeName(18,-9) );
    basesToReplace.push_back( prefix+formatTreeName(19,13) );
    basesToReplace.push_back( prefix+formatTreeName(23,19) );
    basesToReplace.push_back( prefix+formatTreeName(24,-13) );
    basesToReplace.push_back( prefix+formatTreeName(26,8) );
    basesToReplace.push_back( prefix+formatTreeName(27,-5) );
    basesToReplace.push_back( prefix+formatTreeName(28,4) );
    basesToReplace.push_back( prefix+formatTreeName(-16,-9) );
    basesToReplace.push_back( prefix+formatTreeName(-24,-17) );
    basesToReplace.push_back( prefix+formatTreeName(0,-26) );
    ...
    // Nov bases for Paul (truncated list)
    /* 
    basesToReplace.push_back( prefix+formatTreeName(2,11) );
    basesToReplace.push_back( prefix+formatTreeName(25,-8) );
    basesToReplace.push_back( prefix+formatTreeName(18,13) );
    basesToReplace.push_back( prefix+formatTreeName(-17,9) );
    basesToReplace.push_back( prefix+formatTreeName(18,5) );
    basesToReplace.push_back( prefix+formatTreeName(14,-18) ); // 15 mA
    basesToReplace.push_back( prefix+formatTreeName(-5,-26) );
    basesToReplace.push_back( prefix+formatTreeName(-19,0) );
    basesToReplace.push_back( prefix+formatTreeName(12,-17) );
    basesToReplace.push_back( prefix+formatTreeName(11,-12) );
    basesToReplace.push_back( prefix+formatTreeName(-15,22) );
    basesToReplace.push_back( prefix+formatTreeName(-19,-21) );
    basesToReplace.push_back( prefix+formatTreeName(26,3) );
    
    
    //Bases to be pulled out in Nov 2015
    
    // basesToReplace.push_back( prefix+formatTreeName(-15,-15) );
    //  basesToReplace.push_back( prefix+formatTreeName(-14,-15) );
    // South side
    basesToReplace.push_back( prefix+formatTreeName(-5,-26) );
    basesToReplace.push_back( prefix+formatTreeName(-17,-24) );
    basesToReplace.push_back( prefix+formatTreeName(-9,-24) );
    basesToReplace.push_back( prefix+formatTreeName(-16,-23) );
    basesToReplace.push_back( prefix+formatTreeName(-20,-22) );
    basesToReplace.push_back( prefix+formatTreeName(-19,-21) );
    basesToReplace.push_back( prefix+formatTreeName(-19,-12) );
    basesToReplace.push_back( prefix+formatTreeName(-22,-22) );
    basesToReplace.push_back( prefix+formatTreeName(-28,-9) );
    basesToReplace.push_back( prefix+formatTreeName(-14,-1) );
    basesToReplace.push_back( prefix+formatTreeName(-19,0) );
    basesToReplace.push_back( prefix+formatTreeName(-5,2) );
    basesToReplace.push_back( prefix+formatTreeName(-29,3) );
    basesToReplace.push_back( prefix+formatTreeName(-5,3) );
    basesToReplace.push_back( prefix+formatTreeName(-17,9) );
    basesToReplace.push_back( prefix+formatTreeName(-1,13) );    
    basesToReplace.push_back( prefix+formatTreeName(-24,15) );
    basesToReplace.push_back( prefix+formatTreeName(-13,21) );
    basesToReplace.push_back( prefix+formatTreeName(-15,22) );
    basesToReplace.push_back( prefix+formatTreeName(-10,23) );
    basesToReplace.push_back( prefix+formatTreeName(-7,27) );
    // North Side
    basesToReplace.push_back( prefix+formatTreeName(11,-27) );
    basesToReplace.push_back( prefix+formatTreeName(2,-25) );
    basesToReplace.push_back( prefix+formatTreeName(18,-21) );
    basesToReplace.push_back( prefix+formatTreeName(14,-18) );
    basesToReplace.push_back( prefix+formatTreeName(12,-17) );
    basesToReplace.push_back( prefix+formatTreeName(2,-14) );
    basesToReplace.push_back( prefix+formatTreeName(25,-12) );
    basesToReplace.push_back( prefix+formatTreeName(11,-12) );
    basesToReplace.push_back( prefix+formatTreeName(3,-11) );
    basesToReplace.push_back( prefix+formatTreeName(11,-11) );
    basesToReplace.push_back( prefix+formatTreeName(25,-8) );
    basesToReplace.push_back( prefix+formatTreeName(26,3) );
    basesToReplace.push_back( prefix+formatTreeName(18,5) );
    basesToReplace.push_back( prefix+formatTreeName(1,6) );    
    basesToReplace.push_back( prefix+formatTreeName(24,7) );
    basesToReplace.push_back( prefix+formatTreeName(13,11) );
    basesToReplace.push_back( prefix+formatTreeName(2,11) );
    basesToReplace.push_back( prefix+formatTreeName(13,12) );
    basesToReplace.push_back( prefix+formatTreeName(25,12) );
    basesToReplace.push_back( prefix+formatTreeName(18,13) );
    basesToReplace.push_back( prefix+formatTreeName(19,13) );    
    basesToReplace.push_back( prefix+formatTreeName(2,14) );
    basesToReplace.push_back( prefix+formatTreeName(14,15) );
    basesToReplace.push_back( prefix+formatTreeName(20,15) );
    basesToReplace.push_back( prefix+formatTreeName(13,15) );      
    basesToReplace.push_back( prefix+formatTreeName(5,16) );
    basesToReplace.push_back( prefix+formatTreeName(13,19) );
    basesToReplace.push_back( prefix+formatTreeName(15,20) );
    basesToReplace.push_back( prefix+formatTreeName(19,20) );  
    basesToReplace.push_back( prefix+formatTreeName(15,21) );
    basesToReplace.push_back( prefix+formatTreeName(9,23) );
    basesToReplace.push_back( prefix+formatTreeName(8,24) );
    ...
    basesToReplace.push_back(prefix+formatTreeName(-19,-21));
    basesToReplace.push_back(prefix+formatTreeName(-1,13));
    basesToReplace.push_back(prefix+formatTreeName(-22,-12));
    basesToReplace.push_back(prefix+formatTreeName(-24,15));
    basesToReplace.push_back(prefix+formatTreeName(-29,3));
    basesToReplace.push_back(prefix+formatTreeName(-5,-26));
    basesToReplace.push_back(prefix+formatTreeName(-6,-5));
    basesToReplace.push_back(prefix+formatTreeName(-7,27));
    basesToReplace.push_back(prefix+formatTreeName(-9,-24));
    basesToReplace.push_back(prefix+formatTreeName(11,-27));
    basesToReplace.push_back(prefix+formatTreeName(13,-27));
    basesToReplace.push_back(prefix+formatTreeName(13,11));
    basesToReplace.push_back(prefix+formatTreeName(13,12));
    basesToReplace.push_back(prefix+formatTreeName(13,15));
    basesToReplace.push_back(prefix+formatTreeName(14,15));
    ...
    basesToReplace.push_back(prefix+formatTreeName(18,-9));
    basesToReplace.push_back(prefix+formatTreeName(18,13));
    basesToReplace.push_back(prefix+formatTreeName(19,-22));
    basesToReplace.push_back( prefix+formatTreeName(1,6) );
    basesToReplace.push_back( prefix+formatTreeName(20,15) );
    basesToReplace.push_back( prefix+formatTreeName(22,19) );
    basesToReplace.push_back( prefix+formatTreeName(22,6) );
    basesToReplace.push_back( prefix+formatTreeName(24,7) );
    basesToReplace.push_back( prefix+formatTreeName(25,12) );
    basesToReplace.push_back(prefix+formatTreeName(27,-5));
    basesToReplace.push_back(prefix+formatTreeName(27,-2));
    basesToReplace.push_back(prefix+formatTreeName(28,-9));
    basesToReplace.push_back(prefix+formatTreeName(29,4));
    basesToReplace.push_back(prefix+formatTreeName(2,-14));
    basesToReplace.push_back(prefix+formatTreeName(2,-25));
    basesToReplace.push_back(prefix+formatTreeName(2,14));
    basesToReplace.push_back(prefix+formatTreeName(5,16));
    basesToReplace.push_back(prefix+formatTreeName(3,-11));
    basesToReplace.push_back(prefix+formatTreeName(4,-21));
    basesToReplace.push_back(prefix+formatTreeName(6,-10));
    basesToReplace.push_back(prefix+formatTreeName(7,-23));
    basesToReplace.push_back(prefix+formatTreeName(9,23));
    basesToReplace.push_back(prefix+formatTreeName(25,-14));
    */
  /*
    basesToReplace.push_back( prefix+formatTreeName(-25,12) );
...
void Monitoring_Studies_2D(vector<Monitoring_Channel> adcList, TString type, TString savePlots){
  ...
  TString title = "";
  if (type=="vmon_lo") title = "Number of times HV < 100 Volts";
  ...
  c2D->cd();
  hist2D->Draw("colz");
  if (save) c2D->SaveAs(savePlots+".jpg");
...
void Monitoring_Studies_plot(vector<Monitoring_Channel> adcList, int nCanvas, vector<TString> parseType, TString savePlots){
  ...
  for (int i=0; i<4*nCanvas; i++){
    ...
    if (col_num==0) {
      ...
      adc_canv[c_num] = new TCanvas(canv_name,canv_name,1800,1800);
    ...
    if (col_num==4){
      if (save){
       gPad->Modified();
      adc_canv[c_num]->Update();
        adc_canv[c_num]->SaveAs(savePlots+"-"+StringUtilities::int2TString(c_num+1,StringUtilities::int2TString(nCanvas).Length())+".jpg");
      }
    }
  }
}
...
void Monitoring_Studies_openTTree(TString inputRootFile, TString type = "vmon/dyn/imon/temp/mvb/mvt/dac/status",int nCanvas=10, int skipNum = 0, TString savePlots = ""){
  ...
  for (int i=0; i<nList; i++){
    ...
    for (int j=0; j<nType; j++){
      ...
      for (int k=0; k<nEntries; k++){
        ...
        if (status==0) gr_status0->SetPoint(k,timing/60,base_value);
        if (status==1) gr_status1->SetPoint(k,timing/60,base_value);
        if (type=="vmon"){
          if (base_value<100 && status==1)  n0_lo++;
      ...
      gr_status0->GetYaxis()->SetTitleOffset(1.5);
      gr_status1->GetYaxis()->SetTitleOffset(1.5);
      
      gr_status0->GetYaxis()->SetTitleSize(0.055);
      gr_status1->GetYaxis()->SetTitleSize(0.055);
      
      gr_status0->GetYaxis()->SetLabelOffset(0.005);
      gr_status1->GetYaxis()->SetLabelOffset(0.005);
      
      gr_status0->GetYaxis()->SetLabelSize(0.055);
      gr_status1->GetYaxis()->SetLabelSize(0.055);
      
      gr_status0->GetXaxis()->SetTitleOffset(1.5);
      gr_status1->GetXaxis()->SetTitleOffset(1.5);

      //gr_status0->GetXaxis()->SetNdivisions(505);
      //gr_status1->GetXaxis()->SetNdivisions(505);
      
      gr_status0->GetXaxis()->SetTitleSize(0.055);
      gr_status1->GetXaxis()->SetTitleSize(0.055);
      
      gr_status0->GetXaxis()->SetLabelOffset(0.005);
      gr_status1->GetXaxis()->SetLabelOffset(0.005);
      
      gr_status0->GetXaxis()->SetLabelSize(0.055);
      gr_status1->GetXaxis()->SetLabelSize(0.055);
      
      gr_status0->GetXaxis()->SetTitle("Time (hours)");
      gr_status1->GetXaxis()->SetTitle("Time (hours)");
  ...
  // Plot a certain number of 4 column and number of rows equal to number of types plots 
     Monitoring_Studies_plot(adcList, nCanvas, parseType, savePlots+"ReplaceD_Jan_2016");
