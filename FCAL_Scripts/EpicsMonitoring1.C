...
int scan_monitoring(TString readback = ":status/:imon", TString inequality = ">/</=", double Value = 0, bool compareSetpoint = false, bool expertLocation = true, bool nonexpertLocation = true){
  ...
  if (!compareSetpoint && readback==":imon"){
    monitoringFile = "/gluonfs1/gluex/Subsystems/FCAL/FCAL_Analysis/MonitoringMisc/IValues.txt";
    system("/gluonfs1/gluex/Subsystems/FCAL/FCAL_Analysis/MonitoringMisc/GetIStatus > /gluonfs1/gluex/Subsystems/FCAL/FCAL_Analysis/MonitoringMisc/IValues.txt");
  }
...
void plot_voltages_2d(bool new_data = false){
  string monitoringFile = "/gluonfs1/gluex/Subsystems/FCAL/FCAL_Analysis/MonitoringMisc/IValues.txt";
  if (new_data) {
    cout << "This may take a few minutes..." << endl;
    system("/gluonfs1/gluex/Subsystems/FCAL/FCAL_Analysis/MonitoringMisc/GetHVStatus > /gluonfs1/gluex/Subsystems/FCAL/FCAL_Analysis/MonitoringMisc/IValues.txt");
  }
