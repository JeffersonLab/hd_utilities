...
cmd_setVioletFreq    = 'caput FCAL:pulser:VIOLET:freq_w 100'
cmd_setBlueFreq      = 'caput FCAL:pulser:BLUE:freq_w 100'
cmd_setGreenFreq     = 'caput FCAL:pulser:GREEN:freq_w 100'
