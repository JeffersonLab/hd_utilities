...
void Monitoring_Studies_openTTree(TString inputRootFile, TString type = "vmon/dyn/imon/temp/mvb/mvt/dac/status",int nCanvas = 4, int skipNum = 0, TString savePlots = ""){
