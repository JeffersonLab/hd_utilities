...
def main(argv):
	...
	legend.AddEntry(diff_list_US[1],"Upstream Layer 2 / #sqrt{2}","pl")
	legend.AddEntry(diff_list_US[2],"Upstream Layer 3 / #sqrt{3}","pl")
	legend.AddEntry(diff_list_US[3],"Upstream Layer 4 / #sqrt{4}","pl")
	...
	legend.AddEntry(diff_list_DS[1],"Downstream Layer 2 / #sqrt{2}","pl")
	legend.AddEntry(diff_list_DS[2],"Downstream Layer 3 / #sqrt{3}","pl")
	legend.AddEntry(diff_list_DS[3],"Downstream Layer 4 / #sqrt{4}","pl")
