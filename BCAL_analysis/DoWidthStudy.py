		...
		for rocid in rocid_arr:
			for slot in slot_arr:
				for channel in channel_arr:
					...
					if(layer==1 and is_downstream==0): h_layer1_US_RMS.Fill(hist.GetRMS()/layer)
					if(layer==2 and is_downstream==0): h_layer2_US_RMS.Fill(hist.GetRMS()/layer)
					if(layer==3 and is_downstream==0): h_layer3_US_RMS.Fill(hist.GetRMS()/layer)
					if(layer==4 and is_downstream==0): h_layer4_US_RMS.Fill(hist.GetRMS()/layer)
					if(is_downstream==0): h_global_US_RMS.Fill(hist.GetRMS())
					if(layer==1 and is_downstream==1): h_layer1_DS_RMS.Fill(hist.GetRMS()/layer)
					if(layer==2 and is_downstream==1): h_layer2_DS_RMS.Fill(hist.GetRMS()/layer)
					if(layer==3 and is_downstream==1): h_layer3_DS_RMS.Fill(hist.GetRMS()/layer)
					if(layer==4 and is_downstream==1): h_layer4_DS_RMS.Fill(hist.GetRMS()/layer)
