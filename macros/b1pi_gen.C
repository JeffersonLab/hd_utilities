#define b1pi_gen_cxx
// The class definition in b1pi_gen.h has been generated automatically
...
//
// Root > T->Process("b1pi_gen.C")
// Root > T->Process("b1pi_gen.C","some options")
// Root > T->Process("b1pi_gen.C+")
//
...
void b1pi_gen::Begin(TTree * /*tree*/)
{
...
void b1pi_gen::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t b1pi_gen::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either b1pi_gen::GetEntry() or TBranch::GetEntry()
...
void b1pi_gen::Terminate()
{
   // The Terminate() function is the last function to be called during
   // a query. It always runs on the client, it can be used to present
   // the results graphically or save the results to file.

  TFile *OF = new TFile("b1_pi_plots_gen.root","RECREATE");
  mass_pi0->Write();
  mass_rho->Write();
  mass_omega->Write();
  mass_b1->Write();
