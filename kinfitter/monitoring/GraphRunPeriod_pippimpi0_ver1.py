...
TOP_LEVEL_DATA_LOC =  "/w/halld-scshelf2101/home/jzarling/ForPeople/ForMadison/hd_root_files_FA2018_DATA/"
TOP_LEVEL_MC_LOC   =  "/w/halld-scshelf2101/home/jzarling/ForPeople/ForMadison/hd_root_files_FA2018_MC/"
...
#COLLECTING FILE NAMES
    ...
    #CHANGE ABOVE LINE TO THE DIRECTORY/FILES YOU NEED
    ...
    x_axis_err =array('f',[])
    for i in range(NumberOfRuns_data): x_axis_err.append(0.)
...
#GETS THE STEP... INFO
    ...
    pullname_array_data = []         
    tempnum_data=0
    f_data = TFile.Open(TOP_LEVEL_DATA_LOC+'/hd_root_050685.root')    #this is needed just to get this f bit to run; f will be redefined later
    #CHANGE ABOVE LINE TO THE DIRECTORY/FILES YOU NEED; THE NUMBER AT THE END CAN BE ANY FILE THAT IS CONTAINED WITHIN THE DATASET
    ...
    for key_data in topdir_keys_data:
        ...
        if key_string_data == 'pi0pippim__B4_F1_M7': #CHANGE TO THE REACTION YOU WANT TO STUDY
                    ...
                    if IsTDir(subsubdir_data): 
                        ...
                        for subsubkey_data in subsubdir_keys_data:
                            ...
                            if 'Step' in subsubkey_string_data:
                                ...
                                subsubkey_array_data.insert(tempnum_data, subkey_string_data+'/'+subsubkey_string_data) 
                                
    #MC
    subsubkey_array_mc = []    
    pullname_array_mc = []         
    tempnum_mc=0
    f_mc = TFile.Open(TOP_LEVEL_MC_LOC+'/hd_root_050685.root')    #this is needed just to get this f bit to run; f will be redefined later
    #CHANGE ABOVE LINE TO THE DIRECTORY/FILES YOU NEED; THE NUMBER AT THE END CAN BE ANY FILE THAT IS CONTAINED WITHIN THE DATASET
    ...
    for key_mc in topdir_keys_mc:
        ...
        if key_string_mc == 'pi0pippim__B4_F1_M7': #CHANGE TO THE REACTION YOU WANT TO STUDY
                    ...
                    if IsTDir(subsubdir_mc): 
                        ...
                        for subsubkey_mc in subsubdir_keys_mc:
                            ...
                            if 'Step' in subsubkey_string_mc:
                                ...
                                subsubkey_array_mc.insert(tempnum_mc, subkey_string_mc+'/'+subsubkey_string_mc)
...
#DATA
            ...
            skewness_array_data = {var1 : array('f') for var1 in pull_var_list_data} # Stores all skewness's in an array in a dictionary. y-axis in graph
            kurtosis_array_data = {var1 : array('f') for var1 in pull_var_list_data} # Stores all kurtosis's in an array in a dictionary. y-axis in graph
            RMS_array_data_err = {var1 : array('f') for var1 in pull_var_list_data} # Stores all RMS errors in an array 
            mean_array_data_err = {var1 : array('f') for var1 in pull_var_list_data} # Stores all mean errors in an array
            skewness_array_data_err = {var1 : array('f') for var1 in pull_var_list_data} # Stores all skewness errors in an array 
            kurtosis_array_data_err = {var1 : array('f') for var1 in pull_var_list_data} # Stores all kurtosis errors in an array 
            for loopcount_data, filename_data in enumerate(filename_list_data):  # opening loop that collects all (x, y)
                ...
                for var1 in pull_var_list_data:
                    tempfilename_data = "pi0pippim__B4_F1_M7/"+partfilename_data+"/"+var2+"/"+var1 #CHANGE TO THE REACTION YOU WANT TO STUDY
                    print tempfilename_data
                    if tempfilename_data:
                        pathname_data = "pi0pippim__B4_F1_M7/"+partfilename_data+"/"+var2+"/"+var1 #CHANGE TO THE REACTION YOU WANT TO STUDY
                        h_data = f_data.Get("pi0pippim__B4_F1_M7/"+partfilename_data+"/"+var2+"/"+var1) #CHANGE TO THE REACTION YOU WANT TO STUDY
                        if hasattr(h_data, 'GetEntries'):
                            #Data
                            num_entries_data = h_data.GetEntries() # Number of times a value was entered into the histogram
                            mean_data = h_data.GetMean() # Avarage value of this histogram (we want it to be 0)
                            RMS_data = h_data.GetRMS() #standard deviation
                            skewness_data = h_data.GetSkewness()
                            kurtosis_data = h_data.GetKurtosis()
                            mean_array_data[var1].append(float(mean_data)) #these will be used in the graphs
                            RMS_array_data[var1].append(float(RMS_data))   
                            skewness_array_data[var1].append(float(skewness_data))
                            kurtosis_array_data[var1].append(float(kurtosis_data))
                            #errors
                            mean_data_err = h_data.GetMean(11) # Avarage vlaue of this histogram (we wnat it to be 0)
                            RMS_data_err = h_data.GetRMS(11) 
                            skewness_data_err = h_data.GetSkewness(11)
                            kurtosis_data_err = h_data.GetKurtosis(11)
                            mean_array_data_err[var1].append(float(mean_data_err)) #these will be used in the graphs
                            RMS_array_data_err[var1].append(float(RMS_data_err))   
                            skewness_array_data_err[var1].append(float(skewness_data_err))
                            kurtosis_array_data_err[var1].append(float(kurtosis_data_err))
                            print("Number of entries in histogram", num_entries_data) #Prints out the results for this data file
                            print("Histogram average:", mean_data)
                            print("Standard Deviation (RMS):", RMS_data)      
...
#MC
            ...
            RMS_array_mc_err = {var1 : array('f') for var1 in pull_var_list_mc} # Stores all RMSs in an array in a dictionary. y-axis in graph
            mean_array_mc_err = {var1 : array('f') for var1 in pull_var_list_mc}# Stores all means in an array in a dictionary. y-axis in graph
            skewness_array_mc_err = {var1 : array('f') for var1 in pull_var_list_mc} 
            kurtosis_array_mc_err = {var1 : array('f') for var1 in pull_var_list_mc}
            for loopcount_mc, filename_mc in enumerate(filename_list_mc):  # opening loop that collects all (x, y)
                ...
                for var1 in pull_var_list_mc:
                    tempfilename_mc = "pi0pippim__B4_F1_M7/"+partfilename_mc+"/"+var2+"/"+var1 #CHANGE TO THE REACTION YOU WANT TO STUDY
                    print tempfilename_mc
                    if tempfilename_mc:
                        pathname_mc = "pi0pippim__B4_F1_M7/"+partfilename_mc+"/"+var2+"/"+var1 #CHANGE TO THE REACTION YOU WANT TO STUDY
                        h_mc = f_mc.Get("pi0pippim__B4_F1_M7/"+partfilename_mc+"/"+var2+"/"+var1) #CHANGE TO THE REACTION YOU WANT TO STUDY
                        if hasattr(h_mc, 'GetEntries'):

                            num_entries_mc = h_mc.GetEntries() # Number of times a value was entered into the histogram
                            #MC
                            mean_mc = h_mc.GetMean() # Avarage vlaue of this histogram (we want it to be 0)
                            RMS_mc = h_mc.GetRMS() #standard deviation
                            skewness_mc = h_mc.GetSkewness()
                            kurtosis_mc = h_mc.GetKurtosis()
                            mean_array_mc[var1].append(float(mean_mc)) #these will be used in the graphs
                            RMS_array_mc[var1].append(float(RMS_mc))   
                            skewness_array_mc[var1].append(float(skewness_mc))
                            kurtosis_array_mc[var1].append(float(kurtosis_mc))
                            #error
                            mean_mc_err = h_mc.GetMean(11) # Avarage vlaue of this histogram (we wnat it to be 0)
                            RMS_mc_err = h_mc.GetRMS(11)
                            skewness_mc_err = h_mc.GetSkewness(11)
                            kurtosis_mc_err = h_mc.GetKurtosis(11)
                            mean_array_mc_err[var1].append(float(mean_mc_err)) #these will be used in the graphs
                            RMS_array_mc_err[var1].append(float(RMS_mc_err))   
                            skewness_array_mc_err[var1].append(float(skewness_mc_err))
                            kurtosis_array_mc_err[var1].append(float(kurtosis_mc_err))
                            print("Number of entries in histogram", num_entries_mc) # Prints out the results for this data file
                            print("Histogram average:", mean_mc)
                            print("Standard Deviation (RMS):", RMS_mc)      
...
###Graphs
            ...
            if var2 == "Proton" or var2 == "Pi+" or var2 == "Pi-":
                if partfilename_data == 'Hist_KinFitResults/Step0__Photon_Proton__Pi0_Pi+_Pi-_Proton': #CHANGE BASED ON WHAT REACTION YOU ARE STUDYING
                    var4 = ["Pull_Px"]#, "Pull_Xx"]
                    var5 = ["Pull_Py"]#, "Pull_Xy"]
                    var9 = ["Pull_Pz"]#, "Pull_Xz"]
                    # CHANGE ABOVE DEPENDING ON WHAT YOUR REACTION STUDYS
                    for var6 in [0]:#,1]:
                    #this prints the graphs for x,y,z mean
                        ...
                        ###Data
                        c3.cd(1)
                        print("numver of runs: ", NumberOfRuns_data)
                        print("run vec data: ", run_vec_data)
                        print("mean array data: ", mean_array_data[var4[var6]])
                        print("x axis err: ", x_axis_err)
                        print("mean data error: ", mean_array_data_err[var4[var6]])
                        gr1 = TGraphErrors(NumberOfRuns_data, run_vec_data, mean_array_data[var4[var6]], x_axis_err, mean_array_data_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        gr2 = TGraphErrors(NumberOfRuns_data, run_vec_data, mean_array_data[var5[var6]], x_axis_err, mean_array_data_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        gr2.SetMarkerSize(1.2) # Makes marker size a bit bigger; standard is 1.0
                        gr2.SetMarkerColor(kRed)
                        gr2.SetMarkerStyle(kFullCircle)
                        gr3 = TGraphErrors(NumberOfRuns_data, run_vec_data, mean_array_data[var9[var6]], x_axis_err, mean_array_data_err[var9[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        ###mc
                        c3.cd(2)
                        gr_1 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, mean_array_mc[var4[var6]], x_axis_err, mean_array_mc_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        gr_2 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, mean_array_mc[var5[var6]], x_axis_err, mean_array_mc_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        gr_3 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, mean_array_mc[var9[var6]], x_axis_err, mean_array_mc_err[var9[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        ##DATA
                        c4.cd(1)
                        gr3 = TGraphErrors(NumberOfRuns_data, run_vec_data, RMS_array_data[var4[var6]], x_axis_err, RMS_array_data_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        gr4 = TGraphErrors(NumberOfRuns_data, run_vec_data, RMS_array_data[var5[var6]], x_axis_err, RMS_array_data_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        gr4.SetMarkerSize(1.2) # Makes marker size a bit bigger; standard is 1.0
                        gr4.SetMarkerColor(kRed)
                        gr4.SetMarkerStyle(kFullCircle)
                        gr5 = TGraphErrors(NumberOfRuns_data, run_vec_data, RMS_array_data[var9[var6]], x_axis_err, RMS_array_data_err[var9[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        ##MC
                        c4.cd(2)
                        gr_3 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, RMS_array_mc[var4[var6]], x_axis_err, RMS_array_mc_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        gr_4 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, RMS_array_mc[var5[var6]], x_axis_err, RMS_array_mc_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        gr_5 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, RMS_array_mc[var9[var6]], x_axis_err, RMS_array_mc_err[var9[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        ##DATA
                        c6.cd(1)
                        grap1 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data[var4[var6]], x_axis_err, skewness_array_data_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap2 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data[var5[var6]], x_axis_err, skewness_array_data_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap3 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data[var9[var6]], x_axis_err, skewness_array_data_err[var9[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        ##mc
                        c6.cd(2)
                        grap_1 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc[var4[var6]], x_axis_err, skewness_array_mc_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap_2 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc[var5[var6]], x_axis_err, skewness_array_mc_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap_3 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc[var9[var6]], x_axis_err, skewness_array_mc_err[var9[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        ##DATA
                        c7.cd(1)
                        grap4 = TGraphErrors(NumberOfRuns_data, run_vec_data, kurtosis_array_data[var4[var6]], x_axis_err, kurtosis_array_data_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap5 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data[var5[var6]], x_axis_err, skewness_array_data_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap6 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data[var9[var6]], x_axis_err, skewness_array_data_err[var9[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        ##MC
                        c7.cd(2)
                        grap_4 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, kurtosis_array_mc[var4[var6]], x_axis_err, kurtosis_array_mc_err[var4[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap_5 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc[var5[var6]], x_axis_err, skewness_array_mc_err[var5[var6]]) # Size of arrays, followed by x,y-axis
                        ...
                        grap_6 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc[var9[var6]], x_axis_err, skewness_array_mc_err[var9[var6]]) # Size of arrays, followed by x,y-axis
            ...
            if partfilename_mc == 'Hist_KinFitResults/Step1__Pi0__Photon_Photon' and var2 == "Photon":  #CHANGE BASED ON WHAT REACTION YOU ARE STUDYING
                tempvar = "Pull_E"+var2
                ...
                try:
                    ...
                    ##Data
                    c1.cd(1)
                    gr = TGraphErrors(NumberOfRuns_data, run_vec_data, mean_array_data["Pull_E"], x_axis_err, mean_array_data_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##MC
                    c1.cd(2)
                    gr_ = TGraphErrors(NumberOfRuns_mc, run_vec_mc, mean_array_mc["Pull_E"], x_axis_err, mean_array_mc_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                    ...
                    c2 = TCanvas("c2","c2",2400,900) # creates a 2400x900 pixel drawing pad called c1; not sure if I have to add 'new' somewhere
                    c2.Divide(2,1)
                    ##DATA
                    c2.cd(1)
                    gra = TGraphErrors(NumberOfRuns_data, run_vec_data, RMS_array_data["Pull_E"], x_axis_err, RMS_array_data_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##MC
                    c2.cd(2)
                    gra_ = TGraphErrors(NumberOfRuns_mc, run_vec_mc, RMS_array_mc["Pull_E"], x_axis_err, RMS_array_mc_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                    ...
                    # the next bit makes the Energy RMS graph
                    c8 = TCanvas("c2","c2",2400,900) # creates a 2400x900 pixel drawing pad called c1; not sure if I have to add 'new' somewhere
                    c8.Divide(2,1)
                    ##DATA
                    c8.cd(1)
                    gra4 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data["Pull_E"], x_axis_err, skewness_array_data_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##MC
                    c8.cd(2)
                    gra_4 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc["Pull_E"], x_axis_err, skewness_array_mc_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                    ...
                    # the next bit makes the Energy RMS graph
                    c9 = TCanvas("c2","c2",2400,900) # creates a 2400x900 pixel drawing pad called c1; not sure if I have to add 'new' somewhere
                    c9.Divide(2,1)
                    ##Data
                    c9.cd(1)
                    gra5 = TGraphErrors(NumberOfRuns_data, run_vec_data, kurtosis_array_data["Pull_E"], x_axis_err, kurtosis_array_data_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##Data
                    c9.cd(2)
                    gra_5 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, kurtosis_array_mc["Pull_E"], x_axis_err, kurtosis_array_mc_err["Pull_E"]) # Size of arrays, followed by x,y-axis
                ...
                try:
                    ...
                    ##DATA
                    c4.cd(1)
                    gr6 = TGraphErrors(NumberOfRuns_data, run_vec_data, mean_array_data["Pull_Xx"], x_axis_err, mean_array_data_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gr7 = TGraphErrors(NumberOfRuns_data, run_vec_data, mean_array_data["Pull_Xy"], x_axis_err, mean_array_data_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gr8 = TGraphErrors(NumberOfRuns_data, run_vec_data, mean_array_data["Pull_Xz"], x_axis_err, mean_array_data_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##DATA
                    c4.cd(2)
                    gr_6 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, mean_array_mc["Pull_Xx"], x_axis_err, mean_array_mc_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gr_7 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, mean_array_mc["Pull_Xy"], x_axis_err, mean_array_mc_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gr_8 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, mean_array_mc["Pull_Xz"], x_axis_err, mean_array_mc_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##DATA
                    c5.cd(1)
                    gra1 = TGraphErrors(NumberOfRuns_data, run_vec_data, RMS_array_data["Pull_Xx"], x_axis_err, RMS_array_data_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra2 = TGraphErrors(NumberOfRuns_data, run_vec_data, RMS_array_data["Pull_Xy"], x_axis_err, RMS_array_data_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra3 = TGraphErrors(NumberOfRuns_data, run_vec_data, RMS_array_data["Pull_Xz"], x_axis_err, RMS_array_data_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##MC
                    c5.cd(2)
                    gra_1 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, RMS_array_mc["Pull_Xx"], x_axis_err, RMS_array_mc_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra_2 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, RMS_array_mc["Pull_Xy"], x_axis_err, RMS_array_mc_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra_3 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, RMS_array_mc["Pull_Xz"], x_axis_err, RMS_array_mc_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##DATA
                    c10.cd(1)
                    gra5 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data["Pull_Xx"], x_axis_err, skewness_array_data_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra5.SetMarkerColor(kBlue)
                    gra5.SetMarkerStyle(kFullCircle) # See https://root.cern.ch/doc/masterclassTAttMarker.html
                    gra6 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data["Pull_Xy"], x_axis_err, skewness_array_data_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra7 = TGraphErrors(NumberOfRuns_data, run_vec_data, skewness_array_data["Pull_Xz"], x_axis_err, skewness_array_data_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##DATA
                    c10.cd(2)
                    gra_5 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc["Pull_Xx"], x_axis_err, skewness_array_mc_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra_5.SetMarkerColor(kBlue)
                    gra_5.SetMarkerStyle(kFullCircle) # See https://root.cern.ch/doc/masterclassTAttMarker.html
                    gra_6 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc["Pull_Xy"], x_axis_err, skewness_array_mc_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra_7 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, skewness_array_mc["Pull_Xz"], x_axis_err, skewness_array_mc_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##Data
                    c11.cd(1)
                    gra8 = TGraphErrors(NumberOfRuns_data, run_vec_data, kurtosis_array_data["Pull_Xx"], x_axis_err, kurtosis_array_data_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra9 = TGraphErrors(NumberOfRuns_data, run_vec_data, kurtosis_array_data["Pull_Xy"], x_axis_err, kurtosis_array_data_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra10 = TGraphErrors(NumberOfRuns_data, run_vec_data, kurtosis_array_data["Pull_Xz"], x_axis_err, kurtosis_array_data_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    ##Data
                    c11.cd(2)
                    gra_8 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, kurtosis_array_mc["Pull_Xx"], x_axis_err, kurtosis_array_mc_err["Pull_Xx"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra_9 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, kurtosis_array_mc["Pull_Xy"], x_axis_err, kurtosis_array_mc_err["Pull_Xy"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra_10 = TGraphErrors(NumberOfRuns_mc, run_vec_mc, kurtosis_array_mc["Pull_Xz"], x_axis_err, kurtosis_array_mc_err["Pull_Xz"]) # Size of arrays, followed by x,y-axis
                    ...
                    gra_10.Draw("PSAME")
                    legendd.Draw() # Doesn't need any arguments
                    c11.SaveAs("splitplotKURTOSIS%s.pdf" % tempvar2) #Saves in current directory, recommend saving as a pdf or png
