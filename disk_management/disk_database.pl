...
$find_dir_command .= " -o -path /volatile/halld/home/mpatsyuk/pdfmap/pdg3_xx51.0_yy25.0_th9.19132_phi32.1408/root";
$find_dir_command .= " -o -path /cache/halld/RunPeriod-2018-08/rawdata/Run051175";
$find_dir_command .= " -o -path /cache/halld/RunPeriod-2018-08/rawdata/Run051170";
$find_dir_command .= " -o -path /cache/halld/RunPeriod-2018-08/rawdata/Run051252";
$find_dir_command .= " -o -path /cache/halld/RunPeriod-2018-08/rawdata/Run051156";
